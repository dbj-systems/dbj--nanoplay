...
namespace dbj
{
    namespace detail
    {
        ...
        detail::scope_guard<Callback> make_scope_guard(Callback&& callback)
            ...
            dbj::detail::scope_guard from befriending a dbj::make_scope_guard
...
////////////////////////////////////////////////////////////////////////////////
template<typename Callback>
dbj::detail::scope_guard<Callback>::scope_guard(Callback&& callback)
noexcept(std::is_nothrow_constructible<Callback, Callback&&>::value)
...
////////////////////////////////////////////////////////////////////////////////
template<typename Callback>
dbj::detail::scope_guard<Callback>::~scope_guard() noexcept
{
    if (m_active)
        m_callback();
}
...
////////////////////////////////////////////////////////////////////////////////
template<typename Callback>
dbj::detail::scope_guard<Callback>::scope_guard(scope_guard&& other)
noexcept(std::is_nothrow_constructible<Callback, Callback&&>::value)
...
////////////////////////////////////////////////////////////////////////////////
template<typename Callback>
inline void dbj::detail::scope_guard<Callback>::dismiss() noexcept
{
    m_active = false;
}
...
////////////////////////////////////////////////////////////////////////////////
template<typename Callback>
inline auto dbj::detail::make_scope_guard(Callback&& callback)
noexcept(std::is_nothrow_constructible<Callback, Callback&&>::value)
