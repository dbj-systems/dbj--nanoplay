...
namespace interop_testing_space {
	...
	inline void consuming_interop_valstat( ) {
		driver([] {return interop_valstat_testing(valstat_kind::EMPTY); }, "Testing EMPTY valstat interop", true ) ;
		driver([] {return interop_valstat_testing(valstat_kind::ERR); }, "Testing ERR valstat interop", true);
		driver([] {return interop_valstat_testing(valstat_kind::INFO); }, "Testing INFO valstat interop", true);
		driver([] {return interop_valstat_testing(valstat_kind::OK); }, "Testing OK valstat interop", true);
	}
	...
	TU_REGISTER([] {
		...
		driver([] { return divider(1,0); }, "calling divider(1,0);", true);
		driver([] { return divider(1,1); }, "calling divider(1,1);", true);
		driver([] { return divider(0,1); }, "calling divider(0,1);", true);
